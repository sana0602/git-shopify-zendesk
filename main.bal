...
shopifyAdmin:ApiKeysConfig config = {
    xShopifyAccessToken: shopifyAccessToken};
shopifyAdmin:Client shopifyClient = check new (shopifyConfig, "https://sanaexpert-gmbh.myshopify.com");
...
zenSupport:Client zendeskClient = check new (zendeskConfig, serviceUrl = "https://sanaexpert.zendesk.com");
